...
3.
    - [x] 형식에 맞춰 입력 요청 및 진행 안내 메시지를 출력하는 기능
      ...
      - [ ] 진행 안내: `딜러와 (사용자명, 사용자명, 사용자명)에게 2장의 카드를 나누었습니다.`
      - [ ] 입력 요청: `(사용자명)는(/은) 한장의 카드를 더 받겠습니까?(예는 y, 아니오는n)`
      - [ ] `예외` 출력할 값이 null이면 예외 발생
4.
    - [ ] 형식에 맞춰 전달받은 정보를 출력하는 기능
      - [  정해진 형식에 맞춰 사용자 별 카드 오픈 정보를 출력한다.
      - [ ] 정해진 형식에 맞춰 사용자 별 카드 오픈 정보와 합산 점수를 함께 출력한다.
      - [ ] 정해진 형식에 맞춰 사용자 이름과 수익을 출력한다.
      - [ ] `예외` 출력할 값이 null이면 예외 발생
5. 
   - [ ] 히트/스탠드 여부를 입력받는 기능
     - [ ] `예외` 정해진 키워드가 아닌 경우 예외 발생
6. 
